...
project = 'Trump'
copyright = '2017, Congred Group'
author = 'Congred contributors'
...
latex_documents = [
    (master_doc, 'Trump.tex', 'Trump Documentation',
     'Congred Group', 'manual'),
]
...
man_pages = [
    (master_doc, 'trump', 'Trump Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Trump', 'Trump Documentation',
     author, 'Trump', 'One line description of project.',
     'Miscellaneous'),
]
